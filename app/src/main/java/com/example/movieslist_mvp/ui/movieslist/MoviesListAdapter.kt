...
import com.example.movieslist_mvp.databinding.ItemRecyclerViewBinding
import com.example.utils.AppConstants
import com.example.utils.ToGenres
import com.squareup.picasso.Picasso

class MoviesListAdapter(private val list: SimilarMoviesResponse) : RecyclerView.Adapter<MoviesListAdapter.MoviesViewHolder>() {

    class MoviesViewHolder private constructor(private val binding: ItemRecyclerViewBinding) : RecyclerView.ViewHolder(binding.root) {
